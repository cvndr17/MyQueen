...
// Dirubah
const pengirim = "Mas Can🖤";
const nomorWa = "628816230598"; // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu";
const pesan = `dalam setiap huruf namamu terukir alasan hatiku memilihmu. Folder sederhana ini kususun dengan cinta sebagai wadah kenangan perjalanan kita. Saat rindu datang, bukalah dan rasakan kehadiranku dalam setiap lembarnya. Seperti namamu yang menjadi melodi indah dalam benakku, folder ini menyimpan kisah cinta kita yang akan selalu hidup dalam hatiku.`;
...
hilang1.addEventListener("click", () => {
  ...
  Swal.fire({
    imageUrl: "/assets/img/Stiker 15 (SFILE.MOBI).gif",
    imageHeight: 120,
    title: "Sayang, Coba Tulis Nama Depan Kamu ?",
...
hilang2.addEventListener("click", () => {
  window.open(
    `https://drive.google.com/drive/folders/1TbMkxfSQ_FGip0uCsrauYtcrybo25FXF?usp=sharing}`,
    "_blank"
  );
});
